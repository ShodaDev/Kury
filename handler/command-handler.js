...
console.log("This is the offical Command and Module/Event Handler made by Kiroo Development / Shoda#1966!".bgBrightCyan.blue);
console.log("Visit website: kiroo.xyz".blue.bgBrightCyan)
module.exports = client => {
  ...
  try{
    ...
    console.log(table.toString().white);
